...
#define DEBUG_ENVIRONMENT 0x0040
...
#define DBGP_INFO(outputstream)                 \
  do                                            \
    {                                           \
      DBGP(DEBUG_INFO, outputstream);           \
    } while(0)

#define DBGP_ENV(outputstream)                  \
  do                                            \
    {                                           \
      DBGP(DEBUG_ENVIRONMENT, outputstream);    \
    } while(0)
